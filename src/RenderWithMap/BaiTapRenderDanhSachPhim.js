...
import style from './BaiTapRenderDanhSachPhim'
const mangPhim = [
    {
        maPhim: 1321,
        tenPhim: "Ted2",
    ...
    renderPhim = () => {
        const jsxPhim = mangPhim.map((phim, index) => {
            return <div className="col-4 mt-3" key={index}>
                <div className="card">
                    {/* <img className="card-img-top hinhAnhPhim" src={phim.hinhAnh} alt={phim.hinhAnh} /> */}
                    <img style={{
                        height: '200px',
                        width: 'auto',
                    }} className="card-img-top hinhAnhPhim" src={phim.hinhAnh} alt={phim.hinhAnh}></img>
                    <div className="card-body">
                <h4 className="card-title" style={{ height: '50px' }}>{phim.tenPhim.length > 50 ? <span>{this.tenPhim.substr(0, 50)} ...</span> : <span>{phim.tenPhim}</span>}</h4>
